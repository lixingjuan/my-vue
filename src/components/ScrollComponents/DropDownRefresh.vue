      ...
      <slot name="pull-refresh">
        <div class="down-tip" v-if="dropDownState == 1">
          <img
            ...
            class="down-img"
            :src="require('@/assets/images/refreshAndReload/' + dropDownInfo.downImg)"
          />
        ...
        <div class="up-tip" v-if="dropDownState == 2">
          <img
            ...
            class="up-img"
            :src="require('@/assets/images/refreshAndReload/' + dropDownInfo.upImg)"
          />
        ...
        <div class="refresh-tip" v-if="dropDownState == 3">
          <img
            ...
            class="refresh-img"
            :src="require('@/assets/images/loading/' + dropDownInfo.refreshImg)"
          />
...
export default {
     ...
     */
		touchMove(e) {
			this.scrollIsToTop =
        document.documentElement.scrollTop || window.pageYOffset || document.body.scrollTop; // safari 获取scrollTop用window.pageYOffset
